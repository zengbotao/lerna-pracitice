...
describe('Validate TS configs', () => {
  it('Validate @wavesdean/eslint-config/typescript', async () => {
  ...
  it('Validate @wavesdean/eslint-config/typescript/vue', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential/typescript', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate @wavesdean/eslint-config/typescript/node', async () => {
