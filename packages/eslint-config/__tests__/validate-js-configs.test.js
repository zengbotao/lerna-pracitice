...
describe('Validate JS configs', () => {
  it('Validate @wavesdean/eslint-config', async () => {
  ...
  it('Validate @wavesdean/eslint-config/es5', async () => {
  ...
  it('Validate @wavesdean/eslint-config/vue', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential/es5', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential/react', async () => {
  ...
  it('Validate @wavesdean/eslint-config/essential/vue', async () => {
  ...
  it('Validate @wavesdean/eslint-config/node', async () => {
